...
#修改文件路径
    ...
    #debugl 不使用预训练
    data_root_model = os.path.join(data_root, "resnet_model")
    model_weight_path = os.path.join(data_root_model, "resnet34-pre.pth")
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            for val_data in val_bar:
                ...
                for label, prediction in zip(val_labels, predict_y):
                    if label == prediction:
